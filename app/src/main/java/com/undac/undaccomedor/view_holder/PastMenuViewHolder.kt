...
import com.undac.undaccomedor.controller.details.MenuDetailsActivity
...
import kotlinx.android.synthetic.main.li_item_menu_past.view.*
import java.text.SimpleDateFormat
import java.util.*

internal class PastMenuViewHolder(itemView: View, override val mApplicationContext: Context) : BaseViewHolder<PastMenuItem>(itemView) {
    ...
    override fun bind(menuDay: PastMenuItem) {
        ...
        if(menuDay.assist==true){
            //itemView.textViewIconAssist.setBackgroundResource(R.drawable.asisst_48)
    ...
    private fun onClick(dayMenu: Menu) {
        try{
            val intent = Intent(mApplicationContext, MenuDetailsActivity::class.java)
